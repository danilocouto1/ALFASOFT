    ...
    public class ContatoController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Contato != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Contato'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Nome,ContatoNumero,Email")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nome,ContatoNumero,Email")] Contato contato)
        {
            if (id != contato.ID)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.Contato'  is null.");
            }
            var contato = await _context.Contato.FindAsync(id);
            if (contato != null)
            {
